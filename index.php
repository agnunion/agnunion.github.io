...
body {
	background-color: #FF6666;
		background-image: url(images/Gung.jpg);
}
-->
</style></head>
<body topmargin="3">
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFCC" class="border">
  ...
  <tr>
    <td height="43" bgcolor="#FFFFFF"><a href="?open=Home"><img src="images/as.png" alt="TOKO BONEKA ONLINE" width="800" border="0"></a></td>
  </tr>
</table>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
	...
	<input name="txtKeyword" type="text" size="30" maxlength="100" Placeholder=Search !!!>
